...
return array(
    ...
    //sign up
    "signup_success"=>"You have been successfully registered, Please verify your email address.",

    "user_signup_failed"=>"Sorry, We are unable to add the user",

    "user_verify_mail_subject"=>"Confirm your CAT account",

    "user_welcome_mail_subject"=>"Welcome to CAT. Try our tests.",

    "user_successful_referral_subject"=>"Your friend :name bought a membership from CAT.com",

    "user_pending_referral_subject"=>"Your friend :name signed up for CAT.com",
    ...
    "user_membership_expired"=>"Hi :name, your CAT membership has expired."
);
